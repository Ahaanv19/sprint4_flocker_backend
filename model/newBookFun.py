...
def initGroups():
    ...
    with app.app_context():
        ...
        groups += [
            Group(name='Authors', section_id=shared_interest_section.id, moderators=[User.query.get(1)]),
            Group(name='Stories', section_id=shared_interest_section.id, moderators=[User.query.get(1)]),
            Group(name='Fun', section_id=shared_interest_section.id, moderators=[User.query.get(1)]),
            Group(name='LitConnect', section_id=shared_interest_section.id, moderators=[User.query.get(1)]),
            Group(name='BookClub Hub', section_id=shared_interest_section.id, moderators=[User.query.get(1)]),
